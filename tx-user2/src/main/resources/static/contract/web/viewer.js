...
// $.ajax({
//   type: 'get',
//   mimeType: 'application/pdf; charset=x-user-defined',
//   async:false,
...
//   }
// })
var token = 'eyJhbGciOiJIUzI1NiJ9.eyJuYmYiOjE1NTI2MTI4NjIsIkluc3RJZCI6NTAyOCwiY2hhbm5lbCI6ImdhdGV3YXkiLCJjdXN0VHlwZSI6MiwiZXhwIjoxNTUyNjk5MjYyfQ.6aMY24wrmicYzKryNRP7oCU6jvsq-P3w_VfmN39h0Ec'
$.ajax({
  type: 'get',
  mimeType: 'application/pdf; charset=x-user-defined',
  async:false,
  url: '/v1/econtract/downloadFileForApi',
  data: { type: '2', path: '/contract/RISKANNOUNCE/RISKANNOUNCE_20190220110857_5.pdf'},
  headers: {
    'consumerAuth': 'KR_econtractTest',
